...
export default function ServicePage() {
  ...
  if (!service) {
    return (
      <main className="min-h-screen bg-background flex items-center justify-center">
        <SeoHead
          title="Service Not Found | Houston Mobile Mechanic"
          description="The requested service page could not be found."
          path={`/services/${params.slug ?? "not-found"}`}
          noIndex
        />
  ...
  return (
    <main className="min-h-screen bg-background w-full overflow-x-hidden flex flex-col">
      <SeoHead
        title={`${service.title} in Houston, TX | Mobile Mechanic 24/7`}
        ...
        schema={{
          ...
          description: service.metaDescription,
          url: `https://houstonmobilemechanics247.com/services/${service.slug}`,
          areaServed: { "@type": "City", name: "Houston" },
          provider: { "@id": "https://houstonmobilemechanics247.com/#business" },
